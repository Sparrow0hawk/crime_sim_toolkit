...
Original file is located at
    https://colab.research.google.com/github/Sparrow0hawk/Project_2_PoliceDemand/blob/master/CrimeLogGenerator/transition_prob_by_pop/week_LSOA_sim_colab.ipynb
"""
...
! git clone https://github.com/Sparrow0hawk/policedata_dump

# boot up LSOA lists from 2011 census, this has been filtered for just west yorkshire

LSOA_pop = pd.read_csv(glob.glob('/content/policedata*/LSO*/cen*')[0])

LSOA_pop = LSOA_pop[LSOA_pop['Local authority name'].isin(['Bradford','Calderdale', 'Kirklees', 'Leeds', 'Wakefield'])]
